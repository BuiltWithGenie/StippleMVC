...
# !!! Main.UserApp is configured as an alias for Main.StippleMVC and you might encounter it in some tests
using Main.StippleMVC, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "StippleMVC tests" begin
  @includetests ARGS
end
